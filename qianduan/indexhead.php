		...
		<div class="top">
			...
			<!--导航栏-->
			<div class="dhl lf">
				<div class="dhlleft lf">
					<h2>全部商品</h2>
				</div>
				<div class="dhlright lf">
					<span><a href="./index.php"><h2>首页</h2></a></span>
					<?php
					...
					echo "<span><a href='./splb.php?id={$row['id']}'><h2>{$row['name']}</h2></a></span>";
					}
					?>
				</div>
			</div>
			<!--二级菜单-->
				<div class="ejcdleft lf">
						...
						echo "</div>";
						echo "<div class=\"d lf\">";
							$sql2 = "select * from type where pid={$row1['id']}";
							$results = mysqli_query($link,$sql2);
							while($rows=mysqli_fetch_assoc($results)){
								echo "<div class='one'>";
								echo "<a href='./zsplb.php?id={$rows['id']}'>{$rows['name']}</a>";
								echo "</div>";
							}
